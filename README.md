...
A token is used to authenticate a user with the app's backend. Using the token, the server can make decisions for data transfer based on the client’s permission.

- [ ] What steps can you take in your web apps to keep your data secure?

Use a login form which requires username and password, and when these are entered correctly, with the use of a token the user is directed to a protected route.

- [ ] Describe how web servers work.

Web servers as the physical computers, host the code for the various websites and through their connection to the internet share the data with the user computers.
Web servers as the software running in physical servers, tell them what to do to share data with the user's web browser or other applications. They share info using the URL address standard to locate website addresses.
